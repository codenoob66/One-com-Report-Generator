...
def run_automation():
    ...
    with sync_playwright() as p:
        ...
        target_url = "https://onecomhelp.zendesk.com/explore/dashboard/D039494B7CFB701C4C4AA46BC5EDE5F4D357830DEAA9EFAB3C6A5F7037E4F1B3/tab/39682872"
        target_page = None
        ...
        print("Connected to Zendesk dashboard. Waiting for page elements to load...")
        try:
